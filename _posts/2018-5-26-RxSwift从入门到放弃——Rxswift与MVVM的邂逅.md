...
要聊MVVM是什么，就得先聊聊MVC。  
![](https://foolishtalk.oss-cn-shenzhen.aliyuncs.com/mvc.png)    
...
![](https://foolishtalk.oss-cn-shenzhen.aliyuncs.com/mvcnotify.png)  
...
![](https://foolishtalk.oss-cn-shenzhen.aliyuncs.com/MCVMVMV.gif)  
通过这张图就可以看出，MVVM其实就是在MVC的基础上，抽离了Controller的业务逻辑，移到了ViewModel,他们之间其实是这样的关系：  
![](https://foolishtalk.oss-cn-shenzhen.aliyuncs.com/mvvm_logic.png)  
